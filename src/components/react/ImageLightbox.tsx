      ...
      {open && (
        ...
        >
          ...
          <div
            ...
            style={{
              animation: "scaleIn 250ms cubic-bezier(0.25, 0.46, 0.45, 0.94)",
            }}
          >
            {/* Image */}
            ...
            <button
              onClick={() => setOpen(false)}
              className="absolute -top-2 right-4 md:right-0 w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors"
              aria-label="Close"
            >
